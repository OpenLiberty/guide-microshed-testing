...
Remove [hotspot=importMPApp hotspot=importContainer file=0]`import` statements for `ApplicationContainer` and `Container` and the [hotspot=container hotspot=mpApp file=0]`ApplicationContainer app` field.
