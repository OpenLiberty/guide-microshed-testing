...
Typically, projects have multiple test classes that all use the same type of application deployment. For these cases, it is useful to reuse existing configuration and application lifecycle across multiple test classes.
