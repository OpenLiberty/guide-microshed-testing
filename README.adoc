...
To begin bootstrapping, include the `@MicroShedTest` annotation in `PersonServiceIT` class. This annotation indicates that the test class uses MicroShed Testing.
