...
Remove [hotspot=importMPApp hotspot=importContainer file=0]`import` statements and the [hotspot=container hotspot=mpApp file=0]`ApplicationContainer app` field.
